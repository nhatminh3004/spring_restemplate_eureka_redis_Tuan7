...
//    void cau3() {
//        List<SanPham> danhSachNhanVien = nhanvienService.findNhanVienLuongNhoHon10000();
//        System.out.println("Danh sách nhân viên có lương nhỏ hơn 10000 : ");
//        for (SanPham nv : danhSachNhanVien) {
...
//    void cau10() {
//        List<SanPham> danhSachNhanVienLai747 = nhanvienService.findNhanVienBoeing747();
//        System.out.println("Danh sách nhân viên lái máy bay mã số 747  : ");
//
//        for (SanPham nv : danhSachNhanVienLai747) {
//
//            System.out.println(nv);
//        }
//    }
...
//    void cau25() {
//
//        List<SanPham> listNhanVienKhongPhaiPhiCong = nhanvienService.findNhanVienKhongPhaiPhiCong();
//        System.out.println(" Danh sách nhân viên không phải phi công : ");
//        for (SanPham nv : listNhanVienKhongPhaiPhiCong) {
//
//            System.out.println(nv);
//
//        }
